public class TicTacToeGame {
    ...
    public int takeTurn(int index){
        if(turnCounter%2==0){
            switch (index){
                case 0:gameBoard[0][0]=PLAYERX;
                break;
                case 1:gameBoard[0][1]=PLAYERX;
                break;
                case 2:gameBoard[0][2]=PLAYERX;
                break;
                case 3:gameBoard[1][0]=PLAYERX;
                break;
                case 4:gameBoard[1][1]=PLAYERX;
                break;
                case 5:gameBoard[1][2]=PLAYERX;
                break;
                case 6:gameBoard[2][0]=PLAYERX;
                break;
                case 7:gameBoard[2][1]=PLAYERX;
                break;
                case 8:gameBoard[2][2]=PLAYERX;
                break;
            }
            ...
            switch (index){
                case 0:gameBoard[0][0]=PLAYERO;
                break;
                case 1:gameBoard[0][1]=PLAYERO;
                break;
                case 2:gameBoard[0][2]=PLAYERO;
                break;
                case 3:gameBoard[1][0]=PLAYERO;
                break;
                case 4:gameBoard[1][1]=PLAYERO;
                break;
                case 5:gameBoard[1][2]=PLAYERO;
                break;
                case 6:gameBoard[2][0]=PLAYERO;
                break;
                case 7:gameBoard[2][1]=PLAYERO;
                break;
                case 8:gameBoard[2][2]=PLAYERO;
                break;
            }
        }
        turnCounter++;
